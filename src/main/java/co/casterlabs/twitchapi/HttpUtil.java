...
public class HttpUtil {
    ...
    public static Response sendHttp(@NonNull String body, @NonNull String address, @Nullable Map<String, String> headers, @Nullable String mime, @Nullable TwitchAuth auth) throws IOException {
